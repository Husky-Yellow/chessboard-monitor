...
import { King, Pawn } from './pragmatic-drag-and-drop/docs/examples/pieces/getting-started/draggable-piece-with-data';
import Square from './pragmatic-drag-and-drop/docs/examples/pieces/getting-started/square-with-data';
